...
__ALIGN_BEGIN uint8_t MY_USBD_FS_DeviceDesc[USB_LEN_DEV_DESC] __ALIGN_END =
{
  0x12,                       /*bLength */
  ...
  LOBYTE(MY_USBD_VID),           /*idVendor*/
  HIBYTE(MY_USBD_VID),           /*idVendor*/
  LOBYTE(MY_USBD_PID_FS),        /*idProduct*/
  HIBYTE(MY_USBD_PID_FS),        /*idProduct*/
